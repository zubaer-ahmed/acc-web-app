...
<!--  >-->
<!--    <Icon name="ph:magnifying-glass-duotone" class="text-muted-400 h-5 w-5" />-->
<!--  </button>-->
  <BaseButton shape="curved" color="primary" to="/auth/signin" shadow="hover" class="!h-12 w-44"> Signin </BaseButton>
</template>
