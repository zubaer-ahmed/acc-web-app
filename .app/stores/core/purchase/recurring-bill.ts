...
import {useRecurringBill} from '@/composables/core/purchase/recurring-bill';
...
export const useRecurringBillStore = defineStore('recurring-bill', {
  state: () => ({
  ...
  actions: {
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useRecurringBill();
