...
import {useVendorCredit} from '@/composables/core/purchase/vendor-credit';
...
export const useVendorCreditStore = defineStore('vendor-credit', {
  state: () => ({
  ...
  actions: {
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useVendorCredit();
