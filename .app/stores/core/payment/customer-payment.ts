...
import {useCustomerPayment} from '@/composables/core/payment/customer-payment';
...
export const useCustomerPaymentStore = defineStore('customer-payment', {
  state: () => ({
  ...
  actions: {
    ...
    async setRemove(payload: any) {
      const {remove} = useCustomerPayment();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useCustomerPayment();
    ...
    async setVital(payload: any) {
      const {vital} = useCustomerPayment();
    ...
    async setExport(payload: any) {
      const {unload} = useCustomerPayment();
