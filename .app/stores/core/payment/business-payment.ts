...
import {useBusinessPayment} from '@/composables/core/payment/business-payment';
...
export const useBusinessPaymentStore = defineStore('business-payment', {
  state: () => ({
  ...
  actions: {
    ...
    async setRemove(payload: any) {
      const {remove} = useBusinessPayment();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useBusinessPayment();
    ...
    async setVital(payload: any) {
      const {vital} = useBusinessPayment();
    ...
    async setExport(payload: any) {
      const {unload} = useBusinessPayment();
