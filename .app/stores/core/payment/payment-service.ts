...
import {usePaymentService} from '@/composables/core/payment/payment-service';
...
export const usePaymentServiceStore = defineStore('payment-service', {
  state: () => ({
  ...
  actions: {
    ...
    async setRemove(payload: any) {
      const {remove} = usePaymentService();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = usePaymentService();
    ...
    async setExport(payload: any) {
      const {unload} = usePaymentService();
