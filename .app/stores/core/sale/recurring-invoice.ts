...
import {useRecurringInvoice} from '@/composables/core/sale/recurring-invoice';
...
export const useRecurringInvoiceStore = defineStore('recurring-invoice', {
  ...
  actions: {
    ...
    async setEdit(payload: any) {
      const {edit} = useRecurringInvoice();
    ...
    async setRemove(payload: any) {
      const {remove} = useRecurringInvoice();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useRecurringInvoice();
    ...
    async setRead(payload: any) {
      const {read} = useRecurringInvoice();
    ...
    async setList(payload: any) {
      const {list} = useRecurringInvoice();
    ...
    async setVital(payload: any) {
      const {vital} = useRecurringInvoice();
    ...
    async setImport(payload: any) {
      const {load} = useRecurringInvoice();
    ...
    async setExport(payload: any) {
      const {unload} = useRecurringInvoice();
