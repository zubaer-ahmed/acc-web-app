...
import {useInventoryAdjustment} from '@/composables/core/item/inventory-adjustment';
...
export const useInventoryAdjustmentStore = defineStore('inventory-adjustment', {
  state: () => ({
  ...
  actions: {
    async setAdd(payload: any) {
      const {add} = useInventoryAdjustment();
    ...
    async setEdit(payload: any) {
      const {edit} = useInventoryAdjustment();
    ...
    async setRemove(payload: any) {
      const {remove} = useInventoryAdjustment();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useInventoryAdjustment();
    ...
    async setRead(payload: any) {
      const {read} = useInventoryAdjustment();
    ...
    async setList(payload: any) {
      const {list} = useInventoryAdjustment();
    ...
    async setVital(payload: any) {
      const {vital} = useInventoryAdjustment();
    ...
    async setImport(payload: any) {
      const {load} = useInventoryAdjustment();
    ...
    async setExport(payload: any) {
      const {unload} = useInventoryAdjustment();
