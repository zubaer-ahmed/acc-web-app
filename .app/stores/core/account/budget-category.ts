...
import {useBudgetCategory} from '@/composables/core/account/budget-category';
...
export const useBudgetCategoryStore = defineStore('budget-category', {
  state: () => ({
  ...
  actions: {
    ...
    async setRemove(payload: any) {
      const {remove} = useBudgetCategory();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useBudgetCategory();
    ...
    async setExport(payload: any) {
      const {unload} = useBudgetCategory();
