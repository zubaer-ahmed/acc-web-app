...
import {useFixedAssetNBV} from '@/composables/core/account/fixed-asset-nbv';
...
export const useFixedAssetNBVStore = defineStore('fixed-asset-nbv', {
  state: () => ({
  ...
  actions: {
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useFixedAssetNBV();
