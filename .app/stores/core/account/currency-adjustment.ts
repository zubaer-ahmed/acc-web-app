...
import {useCurrencyAdjustment} from '@/composables/core/account/currency-adjustment';
...
export const useCurrencyAdjustmentStore = defineStore('currency-adjustment', {
  state: () => ({
  ...
  actions: {
    async setAdd(payload: any) {
      const {add} = useCurrencyAdjustment();
    ...
    async setEdit(payload: any) {
      const {edit} = useCurrencyAdjustment();
    ...
    async setRemove(payload: any) {
      const {remove} = useCurrencyAdjustment();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useCurrencyAdjustment();
    ...
    async setRead(payload: any) {
      const {read} = useCurrencyAdjustment();
    ...
    async setList(payload: any) {
      const {list} = useCurrencyAdjustment();
    ...
    async setVital(payload: any) {
      const {vital} = useCurrencyAdjustment();
    ...
    async setImport(payload: any) {
      const {load} = useCurrencyAdjustment();
    ...
    async setExport(payload: any) {
      const {unload} = useCurrencyAdjustment();
