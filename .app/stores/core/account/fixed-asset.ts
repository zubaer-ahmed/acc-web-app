...
import {useFixedAsset} from '@/composables/core/account/fixed-asset';
...
export const useFixedAssetStore = defineStore('fixed-asset', {
  state: () => ({
