...
import {useFixedAssetDisposal} from '@/composables/core/account/fixed-asset-disposal';
...
export const useFixedAssetDisposalStore = defineStore('fixed-asset-disposal', {
  state: () => ({
  ...
  actions: {
    async setAdd(payload: any) {
      const {add} = useFixedAssetDisposal();
    ...
    async setEdit(payload: any) {
      const {edit} = useFixedAssetDisposal();
    ...
    async setRemove(payload: any) {
      const {remove} = useFixedAssetDisposal();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useFixedAssetDisposal();
    ...
    async setRead(payload: any) {
      const {read} = useFixedAssetDisposal();
    ...
    async setList(payload: any) {
      const {list} = useFixedAssetDisposal();
    ...
    async setVital(payload: any) {
      const {vital} = useFixedAssetDisposal();
    ...
    async setImport(payload: any) {
      const {load} = useFixedAssetDisposal();
    ...
    async setExport(payload: any) {
      const {unload} = useFixedAssetDisposal();
