...
import {useExchangeRate} from '@/composables/core/account/exchange-rate';
...
export const useExchangeRateStore = defineStore('exchange-rate', {
  ...
  actions: {
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useExchangeRate();
