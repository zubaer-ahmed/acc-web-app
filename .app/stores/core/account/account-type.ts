...
import {useAccountType} from '@/composables/core/account/account-type';
...
export const useAccountTypeStore = defineStore('account-type', {
  state: () => ({
  ...
  actions: {
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useAccountType();
