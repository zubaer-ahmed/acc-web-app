...
import {useAccountTypeLocking} from '@/composables/core/account/account-type-locking';
...
export const useAccountTypeLockingStore = defineStore('account-type-locking', {
  state: () => ({
  ...
  actions: {
    async setAdd(payload: any) {
      const {add} = useAccountTypeLocking();
    ...
    async setEdit(payload: any) {
      const {edit} = useAccountTypeLocking();
    ...
    async setRemove(payload: any) {
      const {remove} = useAccountTypeLocking();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useAccountTypeLocking();
    ...
    async setRead(payload: any) {
      const {read} = useAccountTypeLocking();
    ...
    async setList(payload: any) {
      const {list} = useAccountTypeLocking();
    ...
    async setVital(payload: any) {
      const {vital} = useAccountTypeLocking();
    ...
    async setImport(payload: any) {
      const {load} = useAccountTypeLocking();
    ...
    async setExport(payload: any) {
      const {unload} = useAccountTypeLocking();
