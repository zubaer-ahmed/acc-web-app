...
import {useRecurringJournal} from '@/composables/core/journal/recurring-journal';
...
export const useRecurringJournalStore = defineStore('recurring-journal', {
  state: () => ({
  ...
  actions: {
    ...
    async setEdit(payload: any) {
      const {edit} = useRecurringJournal();
    ...
    async setRemove(payload: any) {
      const {remove} = useRecurringJournal();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useRecurringJournal();
    ...
    async setRead(payload: any) {
      const {read} = useRecurringJournal();
    ...
    async setList(payload: any) {
      const {list} = useRecurringJournal();
    ...
    async setVital(payload: any) {
      const {vital} = useRecurringJournal();
    ...
    async setImport(payload: any) {
      const {load} = useRecurringJournal();
    ...
    async setExport(payload: any) {
      const {unload} = useRecurringJournal();
