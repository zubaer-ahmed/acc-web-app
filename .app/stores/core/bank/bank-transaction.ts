...
import {useBankTransaction} from '@/composables/core/bank/bank-transaction';
...
export const useBankTransactionStore = defineStore('bank-transaction', {
  state: () => ({
  ...
  actions: {
    ...
    async setRemove(payload: any) {
      const {remove} = useBankTransaction();
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useBankTransaction();
    ...
    async setVital(payload: any) {
      const {vital} = useBankTransaction();
    ...
    async setExport(payload: any) {
      const {unload} = useBankTransaction();
