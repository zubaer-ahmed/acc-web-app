...
import {useTaxExemption} from '@/composables/core/tax/tax-exemption';
...
export const useTaxExemptionStore = defineStore('tax-exemption', {
  state: () => ({
  ...
  actions: {
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useTaxExemption();
