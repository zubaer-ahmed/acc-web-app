...
import {useTaxAuthority} from '@/composables/core/tax/tax-authority';
...
export const useTaxAuthorityStore = defineStore('tax-authority', {
  state: () => ({
  ...
  actions: {
    ...
    async setReinstate(payload: any) {
      const {reinstate} = useTaxAuthority();
