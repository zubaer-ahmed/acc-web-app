...
export function useBankAdjustment() {

  const config = useRuntimeConfig();
  const baseURL=config.public.coreApi;

  async function list(payload: any){
    const endpoint=baseURL+'/bank-adjustment/list';
  ...
  async function read(payload: any){
    const endpoint=baseURL+'/bank-adjustment/read';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
    if(!error.value){
      if(data.value && data.value.length!=0){
        const status=data.value.data.original.status;
  ...
  async function add(payload: any){
    const endpoint=baseURL+'/bank-adjustment/add';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
  ...
  async function edit(payload: any){
    const endpoint=baseURL+'/bank-adjustment/edit';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
    if(!error.value){
      if(data.value && data.value.length!=0){
        const status=data.value.data.original.status;
  ...
  async function remove(payload: any){
    const endpoint=baseURL+'/bank-adjustment/remove';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
    if(!error.value){
      if(data.value && data.value.length!=0){
        const status=data.value.data.original.status;
  ...
  async function reinstate(payload: any){
    const endpoint=baseURL+'/bank-adjustment/reinstate';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
    if(!error.value){
      if(data.value && data.value.length!=0){
        const status=data.value.data.original.status;
  ...
  async function vital(payload: any){
    const endpoint=baseURL+'/bank-adjustment/vital';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
    if(!error.value){
      if(data.value && data.value.length!=0){
        const status=data.value.data.original.status;
  ...
  async function load(payload: any){
    const endpoint=baseURL+'/bank-adjustment/import';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
    if(!error.value){
      if(data.value && data.value.length!=0){
        const status=data.value.data.original.status;
  ...
  async function unload(payload: any){
    const endpoint=baseURL+'/bank-adjustment/export';
    const { isFetching, error, data } = await useFetch(endpoint).post(payload).json();
    if(!error.value){
      if(data.value && data.value.length!=0){
        const status=data.value.data.original.status;
