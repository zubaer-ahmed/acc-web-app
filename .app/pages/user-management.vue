...
const sparkLineOne = reactive(useSparkLineSales())
const sparkLineTwo = reactive(sparkLineRevenue())
const sparkLineThree = reactive(sparkLineNewOrders())
const sparkLineFour = reactive(useSparkLineAbandoned())
...
function useSparkLineAbandoned() {
...
<template>
  <div>
    ...
    <div class="mb-8 flex flex-col justify-between md:flex-row md:items-center">
      ...
      <!--          </BaseHeading>-->
      <!--          <BaseParagraph>-->
      <!--            <span class="text-muted-500 dark:text-muted-400"> Happy to see you again on your dashboard. </span>-->
      <!--          </BaseParagraph>-->
      <!--        </div>-->
      <!--      </div>-->
    ...
    <div class="grid grid-cols-12 gap-6">
      ...
      <div class="ptablet:col-span-6 col-span-12 sm:col-span-3">
        <BaseCard class="p-6">
          <div class="flex items-center justify-between">
            <BaseHeading as="h4" size="sm" weight="medium" lead="tight" class="text-muted-400 mb-1">
              <span>Sales</span>
            </BaseHeading>
            <Icon name="ph:shopping-cart-duotone" class="text-primary-500 h-7 w-7" />
          </div>
          <div class="flex items-center justify-between gap-6 pt-4">
            <div class="grow">
              <span class="text-muted-800 dark:text-muted-100 font-sans text-xl font-semibold"> 641.4k </span>
            </div>
            <div class="grow">
      ...
      <div class="ptablet:col-span-6 col-span-12 sm:col-span-3">
        <BaseCard class="p-6">
          ...
          <div class="flex items-center justify-between gap-6 pt-4">
            <div class="grow">
              <span class="text-muted-800 dark:text-muted-100 font-sans text-xl font-semibold"> $389.9k </span>
            </div>
            <div class="grow">
      ...
      <div class="ptablet:col-span-6 col-span-12 sm:col-span-3">
        <BaseCard class="p-6">
          ...
          <div class="flex items-center justify-between gap-6 pt-4">
            <div class="grow">
              <span class="text-muted-800 dark:text-muted-100 font-sans text-xl font-semibold"> 981 </span>
            </div>
            <div class="grow">
      ...
      <div class="ptablet:col-span-6 col-span-12 sm:col-span-3">
        <BaseCard class="p-6">
          ...
          <div class="flex items-center justify-between gap-6 pt-4">
            <div class="grow">
              <span class="text-muted-800 dark:text-muted-100 font-sans text-xl font-semibold"> 43 </span>
            </div>
            <div class="grow">
      ...
      <div class="relative col-span-12 md:col-span-7">
        <BaseCard class="p-6">
          <div class="mb-2 flex items-center justify-between">
            ...
            <NuxtLink to="#" class="bg-muted-100 hover:bg-muted-200 dark:bg-muted-700 dark:hover:bg-muted-900 text-primary-500 rounded-lg px-4 py-2 font-sans text-sm font-medium underline-offset-4 transition-colors duration-300 hover:underline"> Details </NuxtLink>
          </div>
          <div class="flex gap-8">
            <div>
              <span class="text-muted-400 font-sans text-xs">This month</span>
              <p class="text-primary-500 font-sans text-lg font-medium">$75,689</p>
            </div>
            <div>
              <span class="text-muted-400 font-sans text-xs">Last month</span>
              <p class="text-muted-800 dark:text-muted-100 font-sans text-lg font-medium">$59,724</p>
            </div>
            <div>
              <span class="text-muted-400 font-sans text-xs">Average</span>
              <p class="text-muted-800 dark:text-muted-100 font-sans text-lg font-medium">$66,561</p>
            </div>
          </div>
        ...
        <div class="flex h-full flex-col gap-6">
          ...
          <BaseCard class="flex-1 p-6">
            <div class="flex items-center justify-center">
              <div class="flex-1">
                <BaseHeading as="h3" size="md" weight="semibold" lead="tight" class="text-muted-800 mb-4 dark:text-white">
                  <span>Sales Revenue</span>
                </BaseHeading>
                <BaseHeading as="h4" size="lg" weight="light" lead="tight" class="text-muted-800 mb-2 dark:text-white">
                  <span>$8,641.26</span>
                </BaseHeading>
                <BaseParagraph size="xs">
                  <span class="text-muted-400"> The percent is calculated based on forecast. </span>
                </BaseParagraph>
              </div>
              <div class="flex-1">
            ...
            <div class="flex justify-between gap-2">
              <div class="flex flex-1 flex-col gap-2 text-center">
                ...
                <div class="-mt-6">
                  ...
                  <BaseParagraph size="xs">
                    <span class="text-muted-400">Vendor Credit</span>
                  </BaseParagraph>
                </div>
              </div>
              <div class="flex flex-1 flex-col gap-2 text-center">
                ...
                <div class="-mt-6">
                  ...
                  <BaseParagraph size="xs">
                    <span class="text-muted-400">Credit Note</span>
                  </BaseParagraph>
                </div>
              </div>
              <div class="flex flex-1 flex-col gap-2 text-center">
                ...
                <div class="-mt-6">
                  ...
                  <BaseParagraph size="xs">
                    <span class="text-muted-400">Refund</span>
                  </BaseParagraph>
                </div>
              </div>
            </div>
      ...
      <!-- Column -->
      <div class="ltablet:col-span-4 relative col-span-12 md:col-span-6 lg:col-span-3">
      ...
      <!-- Column -->
      <div class="ltablet:col-span-4 relative col-span-12 md:col-span-6 lg:col-span-6">
