...
const onSubmit = handleSubmit(
  async (values) => {
    success.value = false
    console.log('account-type-create-success', values)
    try {
  ...
  (error) => {
    success.value = false
    console.log('account-type-create-error', error)
    document.documentElement.scrollTo({
      top: 0,
      behavior: 'smooth',
    })
      ...
      <div
        ...
        <div>
          ...
          <BaseParagraph size="sm">
            <span class="text-muted-500"> Create a new  Account Type record </span>
          </BaseParagraph>
        </div>
      </div>
            ...
            <div>
              <div>
                <div class="grid grid-cols-12 gap-4">
                  <div class="ltablet:col-span-8 col-span-12 lg:col-span-12">
                    <Field v-slot="{ field, errorMessage, handleChange, handleBlur }" name="name">
                      <BaseInput label="Name" placeholder="Ex: Expense." :model-value="field.value"
