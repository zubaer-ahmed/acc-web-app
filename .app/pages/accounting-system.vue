...
const customRadio = ref('starter')

const plans = [
  {
    name: 'starter',
    description:
    'Full Accounting System Support that is Cloud Hosted.',
    price: {
      monthly: 0,
      yearly: 0,
    },
    features: ['Sales', 'Purchases', 'Reporting'],
    benefits: [
      'Always Free',
      'Customer Support',
  ...
  },
  {
    name: 'agency',
    description:
      'HRM Support to manage Employees or Contractors.',
    price: {
      monthly: 5,
      yearly: 50,
    },
    features: ['Personnel', 'Salary/Wage', 'Leave'],
    benefits: [
  ...
  },
  {
    name: 'business',
    description:
      'Inventory Support to manage medium scale operations.',
    price: {
      monthly: 10,
      yearly: 100,
    },
    features: ['Inventory', 'Stock Level', 'Vendor'],
    benefits: [
      'Integration with Starter',
      'Customer Support',
      'Data Migration Support',
  ...
  },
  {
    name: 'enterprise',
    description:
      'Inventory and Shipping Support to manage large scale operations.',
    price: {
      monthly: 20,
      yearly: 200,
    },
    features: ['Inventory', 'Stock Level', 'Shipping'],
    benefits: [
      'Integration with Starter',
      'Customer Support',
      'Data Migration Support',
      ...
      <div class="grid grid-cols-2 gap-2 xl:gap-6">
        ...
        >
          ...
          >
            ...
            >A basic plan for  SME(Small and Medium Enterprise)</BaseText
            >
          </BaseCard>
        </BaseRadioHeadless>
        <BaseRadioHeadless
        ...
        >
          ...
          >
            ...
            <BaseText size="xs" lead="tight" class="text-muted-400"
            >A plan for Service Oriented Organization</BaseText
            >
          </BaseCard>
        </BaseRadioHeadless>
        <BaseRadioHeadless
        ...
        >
          ...
          >
            ...
            <BaseText size="xs" lead="tight" class="text-muted-400"
            >An affordable plan for Inventory Oriented Organization</BaseText
            >
          </BaseCard>
        </BaseRadioHeadless>
        <BaseRadioHeadless
        ...
        >
          ...
          >
            ...
            <BaseText size="xs" lead="tight" class="text-muted-400"
            >An excellent plan for Inventory and Shipping Oriented Organization</BaseText
            >
          </BaseCard>
        </BaseRadioHeadless>
      </div>
        ...
        <BaseCard shape="rounded" class="p-8">
          ...
          <div class="my-4">
            <BaseParagraph
              ...
              class="text-muted-500 dark:text-muted-400"
            >
              Accomium has incredible features and each plan perfectly adapts to
              your company, whether it is a small business or a bigger one. Accomium
